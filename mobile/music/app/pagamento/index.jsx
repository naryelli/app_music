...
export default Pagamento = () => {
  ...
  const handleAdicionar = () => {
    // Aqui você pode implementar a lógica para adicionar o cartão
    console.log("Cartão adicionado:", { nome, numero, dataValidade, cvv });
  };
    ...
    <View style={style.container}>
      <View style={style.body}>
        ...
        <TextInput
          ...
          placeholder="CVV"
        />
        <Pressable style={style.botao} onPress={handleAdicionar}>
